...
def data(mat_data1,mat_label1):
	...
	for i in range(0,len(modality3_data1),128):
		modality1_data.append(modality1_data1[i:i+128])
		modality2_data.append(modality2_data1[i:i+128])
		modality3_data.append(modality3_data1[i:i+128])
		modality4_data.append(modality4_data1[i:i+128])
...
if __name__ == '__main__':
	...
	# txt1 = open('prakarsh/husformer/Pre_DEAP_list.txt','r').readlines()
	# txt1 = 
	modality11 = []
	modality21 = []
	modality31 = []
	...
	for i,mat_path in enumerate(file_path):
